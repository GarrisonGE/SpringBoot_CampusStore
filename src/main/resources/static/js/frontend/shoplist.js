$(function() {
    ...
    var pageSize = 3;
    // 获取店铺列表的URL
    var listUrl = '/campusstore/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/campusstore/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    $('.shop-list').on('click', '.card', function(e) {
        ...
        window.location.href = '/campusstore/frontend/shopdetail?shopId=' + shopId;
    });
