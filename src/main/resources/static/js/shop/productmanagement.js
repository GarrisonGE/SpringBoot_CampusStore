$(function() {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/campusstore/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/campusstore/shopadmin/modifyproduct';
    getList();
    /**
     * 获取此店铺下的商品列表
     *
        ...
        .on(
            ...
            function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/campusstore/shopadmin/productoperation?productId='
                    ...
                    window.location.href = '/campusstore/frontend/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
